...
// Profile define un perfil de calidad de transcoding.
type Profile struct {
	Name         string
	Width        int
	Height       int
...
var Profiles = map[string]Profile{
	...
	"original": {Name: "original"}, // Direct play, sin transcoding
}

// ProfileNames devuelve los nombres de perfil de mayor a menor calidad.
func ProfileNames() []string {
	return []string{"original", "1080p", "720p", "480p", "360p"}
}

// DefaultProfile devuelve el perfil de transcoding por defecto.
