...
func (h *StudioHandler) List(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		handlers.RespondError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "list studios failed")
		return
	}
...
func (h *StudioHandler) Get(w http.ResponseWriter, r *http.Request) {
	slug := handlers.RequireParam(w, r, "slug")
	if slug == "" {
		return
	}
	...
	if studio == nil {
		handlers.RespondError(w, r, http.StatusNotFound, "NOT_FOUND", "studio not found")
		return
	}
