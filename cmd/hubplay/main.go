...
func run(configPath string) error {
	...
	// ═══ Phase 4c: IPTV ═══
	iptvService := iptv.NewService(repos.Channels, repos.EPGPrograms, repos.Libraries, repos.ChannelFavorites, repos.ChannelOrder, repos.LibraryEPGSources, repos.ChannelOverrides, repos.ChannelWatchHistory, logger)
