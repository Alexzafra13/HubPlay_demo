...
func (h *MePeersHandler) GetPeerItemProgress(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		handlers.RespondError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "failed to read progress")
		return
	}
	...
	handlers.RespondData(w, http.StatusOK, wire)
}
...
func (h *MePeersHandler) PeerContinueWatching(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		handlers.RespondError(w, r, http.StatusInternalServerError, "INTERNAL_ERROR", "failed to list continue watching")
		return
	}
