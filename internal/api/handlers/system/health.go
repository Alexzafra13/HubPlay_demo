...
type HealthHandler struct {
	...
	streamManager handlers.StreamManagerService
	startedAt     time.Time
	version       string
...
func NewHealthHandler(checker db.HealthChecker, sm handlers.StreamManagerService, version, dbPath string) *HealthHandler {
