...
type StreamManagerService interface {
	StartSession(ctx context.Context, userID, itemID, profileName string, caps *stream.Capabilities, startTime float64, audioStreamIndex int) (*stream.ManagedSession, error)
