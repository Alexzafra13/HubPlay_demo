...
// handlers.UserService o sin claims devuelve "" (fail-open) que `AllowedRatings`
...
func (h *SearchHandler) Search(w http.ResponseWriter, r *http.Request) {
	...
	query := q.Get("q")
	if query == "" {
		handlers.RespondError(w, r, http.StatusBadRequest, "VALIDATION_ERROR", "query parameter 'q' is required")
		return
	}
