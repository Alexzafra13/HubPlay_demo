...
func newIdentifyEnv(t *testing.T, id *fakeIdentifier) identifyEnv {
	t.Helper()
	handler := NewItemHandler(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, id, "", testutil.NopLogger())
	r := chi.NewRouter()
...
func TestIdentifyCandidates_NoProviderConfigured(t *testing.T) {
	...
	handler := NewItemHandler(nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, nil, "", testutil.NopLogger())
	r := chi.NewRouter()
