...
// iptvFakeAccess is the minimal handlers.LibraryAccessService fake used by the tests.
...
var (
	...
	_ handlers.IPTVStreamProxyService = (*iptvFakeProxy)(nil)
	_ handlers.LibraryRepository      = (*iptvFakeLibraryRepo)(nil)
	_ handlers.LibraryAccessService   = (*iptvFakeAccess)(nil)
)
...
func newIPTVTestEnv(t *testing.T) *iptvTestEnv {
	...
	env.handler = NewIPTVHandler(env.svc, env.proxy, nil, nil, "", env.libraries, env.access, nil, nil, testutil.NopLogger())
