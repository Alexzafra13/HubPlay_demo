...
var (
	_ handlers.ImageRepository      = (*fakeImageRepo)(nil)
	_ handlers.ExternalIDRepository = (*fakeExternalIDRepo)(nil)
	_ handlers.ItemRepository       = (*fakeItemRepo)(nil)
	_ handlers.ProviderManager      = (*fakeProviderManager)(nil)
)
