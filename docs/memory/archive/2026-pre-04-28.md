# Archivo: sesiones anteriores a 2026-04-27

> **No leer esto al inicio de sesión.** Esto es contexto histórico,
> no estado actual. Para el estado actual leer
> [`project-status.md`](../project-status.md).
>
> Este archivo recoge las "HANDOFF DE SESIONES ANTERIORES" y ciclos
> previos que ocupaban ~1.600 líneas en `project-status.md` y
> ralentizaban la lectura de cada sesión nueva. El contenido está
> intacto, sólo movido. Útil cuando hace falta arqueología sobre
> una decisión vieja (rama `claude/review-pending-tasks-9Vh6U`,
> rama `claude/iptv-channel-health`, ciclos de live-TV coverage,
> simplify sweep, lint debt cero, etc.).
