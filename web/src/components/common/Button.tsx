...
interface ButtonProps extends ButtonHTMLAttributes<HTMLButtonElement> {
  ...
  fullWidth?: boolean;
  children: ReactNode;
  // React 19: `ref` viaja como prop normal en componentes función — ya
  // no necesita `forwardRef`. Lo declaramos explícitamente para que
  // los call sites (DialogTrigger, animaciones que necesitan el nodo)
  // conserven el contrato de antes.
