...
// only stubs are the handlers.StreamManagerService (we don't want ffmpeg in
...
func newFedTestEnv(t *testing.T) *fedTestEnv {
	...
	imageDir := t.TempDir()
	imgSrv := media.NewImageHandler(nil, nil, nil, nil, nil, imageDir, nil, testutil.NopLogger())
...
// fakeImageRepoForFedTest is a tiny handlers.ImageRepository implementation
...
func (r *fakeImageRepoForFedTest) SetPrimary(context.Context, string, string, string) error {
	return nil
}
...
var _ handlers.ImageRepository = (*fakeImageRepoForFedTest)(nil)

// ─── Federated subtitle list endpoint ─────────────────────────────────────

// fakeMediaStreamRepoForFedTest is a tiny handlers.MediaStreamRepository
...
var _ handlers.MediaStreamRepository = (*fakeMediaStreamRepoForFedTest)(nil)
