...
func newAdminAuthFixture(t *testing.T) (*admin.AdminAuthHandler, *auth.KeyStore, *clock.Mock, *[]string) {
	t.Helper()
	...
	h := admin.NewAdminAuthHandler(ks, clk.Now, observer, slog.Default())
