...
// ─── Fake handlers.ProviderRepository ────────────────────────────────────────────────
...
var _ handlers.ProviderRepository = (*providersFakeRepo)(nil)

// Reuses fakeProviderManager from image_test.go for the handlers.ProviderManager dep.
...
func TestProviderHandler_SearchMetadata_Happy(t *testing.T) {
	...
	// handlers.ProviderManager interface with ad-hoc behaviour.
